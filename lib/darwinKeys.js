...
function AttachEventListeners()
{
	...
	var rez_add = objc_msgSend(NSEvent, addLocalMonitorForEventsMatchingMask, TYPES.NSEventMask(NSSystemDefinedMask), SystemEventHandlerBlock_c.address());
	console.log('rez_add:', rez_add, rez_add);
}
