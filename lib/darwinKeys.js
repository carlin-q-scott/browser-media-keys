...
const 
	...
	nil = ctypes.cast(TYPES.NSInteger(0), ctypes.voidptr_t)
...
{	
	...
	rez_add = objc_msgSend(NSEvent, addMonitorForEventsMatchingMask, TYPES.NSEventMask(NSSystemDefinedMask), SystemEventHandlerBlock_c.address());
