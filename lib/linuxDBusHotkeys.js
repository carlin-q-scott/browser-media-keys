...
var postMessage = function(message)
{
    switch (message)
    {
        ...
        case "detach":
            ...
            break;
        case "reattach":
            if (dbus_proxy) GrabMediaPlayerKeys(dbus_proxy);
...
var GrabMediaPlayerKeys = function(proxy)
{
    ...
    console.log('grabbed media keys');
};
...
var AttachEventListeners = function()
{
    ...
    if (handler_id > 0){
        GrabMediaPlayerKeys(dbus_proxy);
        console.log('attached listeners');
    }
    else
    {
        console.log("failed to register with dbus")
        throw "attach failed";
    }
};
