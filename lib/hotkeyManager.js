...
var { EmitEventToActivePageWorker } = pageWorkerManager.EmitEventToActivePageWorker;
...
var RegisterHotkeys = function()
{
    ...
    gWkComm = new Comm.server.worker(core.addon.path.scripts + 'HotkeyWorker.js', ()=>{});
    callInHotkeyworker('attach', { UseMkWin }, function(aSuccess) {
        if (!aSuccess) {
