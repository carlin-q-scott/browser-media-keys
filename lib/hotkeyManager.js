...
var RegisterContentScripts = function(pageDomains, JamstashDomains)
{
	...
	for(let pageDomain of pageDomains)
	{
		if (pageDomain == "youtube.com"){
			...
			var JamNotFound = true;
			for(let JamstashDomain of JamstashDomains)
			{
				if (pageDomain == JamstashDomain){
					contentScriptFiles = "./Jamstash.js";
					JamNotFound = false;
					continue;
				}
			}
			if (JamNotFound){ contentScriptFiles = ["./Finder.js", "./" + pageDomain + "-view.js", "./orchestrator.js"];}
		}
