...
var AttachWorkerToPage = function(worker)
{
    ...
    worker.port.on('Play', function(){ EmitEventToLastActivePageWorker("MediaPause", this); });
    worker.port.on('Pause', function(){ EmitEventToLastActivePageWorker("MediaPlay", this); });
    worker.port.on('Stop', function(){ EmitEventToLastActivePageWorker("MediaPlay", this); });
};
